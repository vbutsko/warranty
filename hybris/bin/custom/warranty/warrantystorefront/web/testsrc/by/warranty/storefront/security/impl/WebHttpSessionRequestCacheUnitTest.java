...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/warrantystorefront/electronics/en",
						"https://electronics.local:9002/warrantystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/warrantystorefront/electronics/en",
						"https://electronics.local:9002/warrantystorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/warrantystorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/warrantystorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/warrantystorefront/electronics/en",
						"https://electronics.local:9002/warrantystorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/warrantystorefront",
						"https://electronics.local:9002/warrantystorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/warrantystorefront",
						"https://electronics.local:9002/warrantystorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/warrantystorefront/electronics/en",
						"https://electronics.local:9002/warrantystorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
