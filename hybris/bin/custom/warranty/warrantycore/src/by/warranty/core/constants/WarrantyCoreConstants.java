 ...
 */
package by.warranty.core.constants;

/**
 * Global class for all WarrantyCore constants. You can add global constants for your extension into this class.
 */
public final class WarrantyCoreConstants extends GeneratedWarrantyCoreConstants
{
	public static final String EXTENSIONNAME = "warrantycore";


	private WarrantyCoreConstants()
	{
		//empty
	}
