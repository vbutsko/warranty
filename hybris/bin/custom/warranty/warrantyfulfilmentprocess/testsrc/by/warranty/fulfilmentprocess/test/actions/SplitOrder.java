 ...
 */
package by.warranty.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(WarrantyFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(WarrantyFulfilmentProcessConstants.PARENT_PROCESS);
