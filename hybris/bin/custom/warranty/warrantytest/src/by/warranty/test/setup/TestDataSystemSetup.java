 ...
 */
package by.warranty.test.setup;
...
import by.warranty.test.constants.WarrantyTestConstants;
import by.warranty.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = WarrantyTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/warrantytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/warrantytest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/warrantytest/import/cstickets.impex");
			...
			importImpexFile(context, "/warrantytest/import/csquotes.impex");
		}
	}
}
