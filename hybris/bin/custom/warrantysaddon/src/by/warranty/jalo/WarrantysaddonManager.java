...
import by.warranty.constants.WarrantysaddonConstants;



/**
 * This is the extension manager of the Warrantysaddon extension.
 */
public class WarrantysaddonManager extends GeneratedWarrantysaddonManager
{
	 ...
	 */
	public static WarrantysaddonManager getInstance()
	{
		return (WarrantysaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WarrantysaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WarrantysaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WarrantysaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WarrantysaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WarrantysaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
